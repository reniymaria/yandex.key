...
public class SavePasswordWithMP {
    ...
    public boolean check() {
        ...
        driver.findElement(By.id("ru.yandex.key:id/switch_yandex_acc_pin")).click();
        ...
        driver.pressKeyCode(AndroidKeyCode.BACK);
        Boolean text = driver.findElementsByName("Войти по QR-коду").size() != 0;
        driver.quit();
        return text;
    }
}
