...
public class TimeCheck {
    ...
    public boolean check() {
        ...
        driver.findElement(By.id("ru.yandex.key:id/help")).click();
        driver.findElement(By.id("ru.yandex.key:id/faq_time_diff_answer")).click();
        Boolean title = driver.findElementsByName("Проблемы и решения").size() != 0;
        driver.quit();
        return title;
    }
